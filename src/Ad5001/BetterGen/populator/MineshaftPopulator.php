...
class MineshaftPopulator extends AmountPopulator{
	 ...
	 * @param Random $random
	 */
	public function generateMineshaftPart(int $x, int $y, int $z, int $dir, Random $random): void{
			...
			case self::TYPE_FORWARD :
				switch($dir){
					case self::DIR_XPLUS :
						...
						// Putting rails
						BuildingUtils::fillCallback(new Vector3($x, $y, $z), new Vector3($x + 4, $y, $z), function(Vector3 $v3, ChunkManager $level, Random $random){
