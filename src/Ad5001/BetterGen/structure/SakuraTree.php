...
class SakuraTree extends Tree{
	...
	public const TRUNK_POS = [  // Checks for trees trunks. Not automatically generated but there is no point of making more or less
		7  => [
			0,
			1
		],
	...
	public const DIAG_LEAVES = [  // Diag poses of the leaves based on the height of the tree.X relative to $lastX and Z from $lastZ
		7  => [
			[
				4,
				4
	...
	public const ADDITIONAL_BLOCKS = [  // Blocks who aren't set to fully fill the tree. X relative to $lastX and Z from $lastZ
		7  => [],
		8  => [],
		9  => [],
		10 => [],
